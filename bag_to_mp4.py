...
# Parameters
rosbag_path = "/path/to/your/rosbag.bag"  # Path to your rosbag file
topic_name = "/camera/image_raw"          # Topic to subscribe to
output_video_path = "output_video.mp4"    # Path to save the video
